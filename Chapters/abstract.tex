...
We show why we believe that the state of the art needs to be improved, and what approach we suggest in dealing with this kind of data.
We present a set of approaches and tools to collect data from software failures, model it, and turn it into actionable knowledge.
Our goal is to show that data generated from errors can have a great impact on daily software development, and how it can be employed to augment the development environment to assist software engineers to build and maintain software ecosystems.
