...
%%%%%%%%%%%%%%%%%%%%%%
\section{The Rise of Gamification}
%%%%%%%%%%%%%%%%%%%%%%
...
The examples in \secref{sec:gamificationframework} hint at a fact that should not be disregarded about gamification: To create such environments is a far from trivial endeavour.
