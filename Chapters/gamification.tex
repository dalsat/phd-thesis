...
% Perspectives track: A paper in which the main contribution is a novel perspective on the field as a whole, or part thereof.
...
First, we discuss the principles of game design (\secref{sec:principles:games}) and gamification (\secref{sec:principles:gamification}).
...
\textbf{Conflicts}: Some gamification elements can create conflicts with existing elements on the system.
...
The examples in \secref{sec:framework} hint at a fact that should not be disregarded about gamification: To create such environments is a far from trivial endeavour.
