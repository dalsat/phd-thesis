...
The already mentioned survey performed by Zimmermann \etal finds that one of the biggest problems comes from the reliability of the reported data~\cite{Zimm2010a}, hinting at the need for an automated approach that collects meaningful data.
...
To support developers deal with an issue, there have been a few efforts in introducing \emph{gamification} ---the use of game elements in a non gaming context--- into software engineering.
