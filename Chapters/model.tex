...
In \secref{sec:model-discussion} we discuss the meaning of our findings, while in \secref{sec:model-summary} we summarize and conclude the chapter.
...
{\bfseries Tracker} & {\bfseries State} & {\bfseries Current} & {\bfseries Total} \\ \hline
...
%%%%%%%%%%%%%%%%%%%%
\section{Threats to Validity} \label{sec:model-discussion}
%%%%%%%%%%%%%%%%%%%%
...
We saw how automation can support developers in their maintenance task, but we are still left to face with the issue that bug fixing is a tedious activity.
In the next chapter we explore the field of \emph{gamification} and investigate whether its use can help developers and communities in processing the large amount of unstructured information that populates issue tracking systems.
