...
% \chapter{\ib: Visual Analytics of Bug Repositories}\label{ch:visualize}
...
Developing and using \ib we verified that providing a visual feedback of data that is usually consumed through plain text is an effective method to observe and investigate properties that would normally be hard to spot.
For example, in \figref{fig:inbug} we
