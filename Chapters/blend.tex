...
The mining of such unstructured data has become a research field of its own in the past few years, creating also a workshop of its own~\cite{Bett2010a}.
...
We think that a similar approach of combining data can be effectively put into use when analyzing old code, to understand and maintain legacy systems and support software archaeology~\cite{Hunt2002a}.
